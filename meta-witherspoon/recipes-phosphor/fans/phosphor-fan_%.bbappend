FILESEXTRAPATHS_append := "${THISDIR}/${MACHINE}-${PN}:"
...
# Do not install presence, monitor, and cooling type applications for Swift bring-up
FAN_PACKAGES_remove_swift = "${PN}-presence-tach ${PN}-monitor phosphor-cooling-type"
PACKAGECONFIG_remove_swift = "presence monitor cooling-type"
