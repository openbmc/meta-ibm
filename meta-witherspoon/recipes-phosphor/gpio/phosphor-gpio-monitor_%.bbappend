...
SYSTEMD_LINK_${PN}-presence_append_mihawk = " ${@compose_list(d, 'FMT', 'OBMC_FRU_INSTANCES')}"
...
SYSTEMD_ENVIRONMENT_FILE_${PN}-presence_append_mihawk = " ${@compose_list(d, 'POWERSUPPLY_ENV_FMT', 'OBMC_FRU_INSTANCES')}"
